...
handler.before = function (m) {
    ...
    let role = (user.level <= 3) ? 'Veteran V'
                                                                                            ...
                                                                                            : ((user.level >= 66) && (user.level <= 69)) ? 'Epic III'
                                                                                                : ((user.level >= 69) && (user.level <= 71)) ? 'Epic II'
                                                                                                    : ((user.level >= 71) && (user.level <= 74)) ? 'Epic I'
                                                                                                        : ((user.level >= 74) && (user.level <= 77)) ? 'Legendary V'
                                                                                                            : ((user.level >= 77) && (user.level <= 80)) ? 'Legendary IV'
                                                                                                                : ((user.level >= 80) && (user.level <= 83)) ? 'Legendary III'
                                                                                                                    : ((user.level >= 83) && (user.level <= 86)) ? 'Legendary II'
                                                                                                                        : ((user.level >= 86) && (user.level <= 89)) ? 'Legendary I'
